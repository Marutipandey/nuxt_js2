...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-4e6f81f0.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-404-86dcbe5a.mjs').then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-500-3a107dd7.mjs').then((r) => r.default || r));
...
export { _export_sfc as _, useRouter as a, parseQuery as b, withoutTrailingSlash as c, createError as d, hasProtocol as h, navigateTo as n, parseURL as p, server as s, useHead as u, withTrailingSlash as w };
